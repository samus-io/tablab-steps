...
* There are various bypassing methods that belong to this category:
  ...
  * **Filename Limits**: use long filenames to truncate safe extensions. For example, Linux max length is typically **255** bytes, so create a name `abc...abc.php.png` where `abc...abc` in a long string.
