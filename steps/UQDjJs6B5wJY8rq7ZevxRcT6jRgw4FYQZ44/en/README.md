...
* An example is the URL used to access accounts like `/customer_account?customer_number=132355`, you can change the **customer_number** parameter to **132356** to access another user's account.
...
* For instance, try accessing `/static/<file_name>` or `<robots.txt>` and discover if it contains sensitive information belonging to another user without requiring authentication.
