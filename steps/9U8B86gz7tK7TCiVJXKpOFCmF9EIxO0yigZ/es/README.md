...
* El más común es `NFC`. A menudo se recomienda como la opción por defecto porque es ampliamente utilizada y compatible con muchos sistemas y protocolos.
...
* A continuación se muestran dos fragmentos de código que ilustran un caso de uso.
